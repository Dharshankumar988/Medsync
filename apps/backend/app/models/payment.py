...
class Payment(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[PaymentStatus] = mapped_column(String(50), default=PaymentStatus.PENDING, index=True)
...
class Invoice(Base, UUIDMixin, TimestampMixin):
    ...
    payment_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("payments.id"), index=True, unique=True, nullable=False)
