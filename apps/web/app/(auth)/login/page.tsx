...
import { Activity, Shield, Loader2, ArrowRight, LockKeyhole, Mail, Eye, EyeOff, CheckCircle2, Brain } from "lucide-react";
              ...
              <motion.div variants={fadeUp} className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`h-12 pl-10 pr-12 bg-background border-input hover:border-muted-foreground/30 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/40 transition-all duration-200 ${errors.password ? "border-destructive/50 focus:border-destructive" : ""}`}
                    {...register("password")}
                  />
                  <button
                    type="button"
